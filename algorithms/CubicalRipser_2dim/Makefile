TARGET = CR2
SRCS = main.cpp cubicalripser_2dim.cpp dense_cubical_grids.cpp birthday_index.cpp columns_to_reduce.cpp simplex_coboundary_enumerator.cpp union_find.cpp write_pairs.cpp compute_pairs.cpp
